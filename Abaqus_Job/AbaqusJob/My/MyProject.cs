...
internal sealed class MyProject
{
	...
	internal sealed class MyForms
	{
		...
		[EditorBrowsable(EditorBrowsableState.Never)]
		public ScheduleSetupForm m_ScheduleSetupForm;
		...
		public ScheduleSetupForm ScheduleSetupForm
		{
			[DebuggerHidden]
			get
			{
				m_ScheduleSetupForm = Create__Instance__(m_ScheduleSetupForm);
				return m_ScheduleSetupForm;
			}
			[DebuggerHidden]
			set
			{
				if (value != m_ScheduleSetupForm)
				{
					if (value != null)
					{
						throw new ArgumentException("Property can only be set to Nothing");
					}
					Dispose__Instance__(ref m_ScheduleSetupForm);
				}
			}
		}
